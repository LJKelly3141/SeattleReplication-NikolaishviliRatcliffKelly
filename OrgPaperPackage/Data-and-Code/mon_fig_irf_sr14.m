...
sr14IRFcredset = prctile(sr14IRF,[16 50 84],1)/median(sr14IRF(:,1,1))*0.25;
...
for j = 1:n
    ...
    d_sr14 = (sr14IRFcredset(1,1:H,j))';  
    d_base = (baseIRFcredset(1,1:H,j))';  
    m_sr14  = (sr14IRFcredset(2,1:H,j))';  
    m_base  = (baseIRFcredset(2,1:H,j))';  
    u_sr14 = (sr14IRFcredset(3,1:H,j))';  
    ...
    f_sr14 = fill([1:H fliplr(1:H)],[u_sr14' fliplr(d_sr14')],[1 0.5 0],'EdgeColor',[1 0.5 0]);
    f_sr14.FaceAlpha = 0.25;
    plot([1:H],(m_sr14),'Color',[1 0.5 0],'LineStyle','-','LineWidth',0.75,'HandleVisibility','off');
...
print('-fillpage','-dpdf','mon_fig_irf_sr14')
