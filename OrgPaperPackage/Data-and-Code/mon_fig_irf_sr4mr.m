...
sr4mrIRFcredset = prctile(sr4mrIRF,[16 50 84],1)/median(sr4mrIRF(:,1,1))*0.25;
...
for j = 1:n
    ...
    d_sr4mr = (sr4mrIRFcredset(1,1:H,j))';  
    d_base = (baseIRFcredset(1,1:H,j))';  
    m_sr4mr  = (sr4mrIRFcredset(2,1:H,j))';  
    m_base  = (baseIRFcredset(2,1:H,j))';  
    u_sr4mr = (sr4mrIRFcredset(3,1:H,j))';  
    ...
    f_sr4mr = fill([1:H fliplr(1:H)],[u_sr4mr' fliplr(d_sr4mr')],[1 0.5 0],'EdgeColor',[1 0.5 0]);
    f_sr4mr.FaceAlpha = 0.25;
    plot([1:H],(m_sr4mr),'Color',[1 0.5 0],'LineStyle','-','LineWidth',0.75,'HandleVisibility','off');
...
print('-fillpage','-dpdf','mon_fig_irf_sr4mr')
